...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [2] = LAYOUT_split_3x6_3(
         KC_GRV, KC_TRNS, KC_LBRC, KC_BSLS, KC_RBRC, KC_TRNS,        KC_TRNS, KC_AMPR, KC_ASTR, KC_MINS, KC_TRNS, KC_DEL,
        KC_TRNS, KC_TRNS, KC_LPRN, KC_UNDS, KC_RPRN, KC_TRNS,        KC_TRNS, KC_DLR,  KC_PERC, KC_CIRC, KC_EQL,  KC_TRNS,
        KC_TRNS, KC_TRNS, KC_LCBR, KC_PIPE, KC_RCBR, KC_TRNS,        KC_TRNS, KC_EXLM, KC_AT,   KC_HASH, KC_TRNS, KC_TRNS,
                                   KC_TRNS, KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS, KC_TRNS
    ),
